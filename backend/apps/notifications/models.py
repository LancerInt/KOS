...
class NotificationEvent(models.TextChoices):
    ...
    REVIEW_SENT_BACK = "review_sent_back", "Sent back for changes"
    ...
    COMPLIANCE_DUE = "compliance_due", "Statutory filing due"
    COMPLIANCE_OVERDUE = "compliance_overdue", "Statutory filing overdue"
